...
docker run --name=${pjName} -d --restart=always --privileged=true --network my_net -p 81:81 -v /home/liuzhaomax1/ftp/static:/usr/src/app/static ${pjName}-i